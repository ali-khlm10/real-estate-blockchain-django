...
urlpatterns = [
    ...
    path("agent_received_requests/", views.agentReceivedRequestsView.as_view(), name='agent-received-requests'),
    path("agent_accept_request/<int:property_id>", views.agentAcceptRequestView.as_view(), name='agent-accept-request'),
    path("agent_reject_request/<int:property_id>", views.agentRejectRequestView.as_view(), name='agent-reject-request'),
