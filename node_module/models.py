...
class nodeModel(models.Model):
    node_name = models.CharField(verbose_name="نام گره", max_length=50,unique=True)
    node_port = models.CharField(verbose_name="شماره پورت", max_length=50,unique=True)
    node_url = models.URLField(verbose_name="آدرس گره", max_length=200,unique=True)
